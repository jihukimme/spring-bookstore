...
public interface BookService {
    ...
    // Page<BookDto> searchBooks(String title, String publisher, String author, Integer stockQuantity, String status, LocalDateTime startDate, LocalDateTime endDate, Pageable pageable);
